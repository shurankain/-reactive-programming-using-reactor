...
public class MovieInfoService {
    ...
    public Flux<MovieInfo> retrieveMoviesFlux() {
        ...
        var movieInfoList = List.of(new MovieInfo(100l, "Batman Begins", 2005, List.of("Christian Bale", "Michael " +
                        "Cane"), LocalDate.parse("2005-06-15")),
    ...
    public List<MovieInfo> movieList() {
        ...
        return List.of(new MovieInfo(100L, "Batman Begins", 2005, List.of("Christian Bale", "Michael Cane"),
                        LocalDate.parse("2005-06-15")),
                new MovieInfo(101L, "The Dark Knight", 2008, List.of("Christian Bale", "HeathLedger"),
                        LocalDate.parse("2008-07-18")),
                new MovieInfo(102L, "Dark Knight Rises", 2008, List.of("Christian Bale", "Tom Hardy"),
